  ...
  return (
    <div className="min-h-screen bg-gradient-background relative overflow-hidden">
      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center p-6">
        ...
        {currentScene === 2 && (
          <div className="text-center space-y-8">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-accent">
              <TypingText
        ...
        {currentScene === 4 && (
          <div className="text-center space-y-8 relative z-20">
            <div className="animate-scale-in">
              <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl font-bold bg-gradient-party bg-clip-text text-transparent mb-8 text-center">
                🎉 C'est l'anniversaire d'Aristide !! 🎉
              </h2>
            </div>
            {/* <div className="text-2xl text-primary font-semibold animate-bounce">
              Cliquez partout pour plus de feux d'artifice !
            </div> */}
          </div>
        )}
        ...
        {currentScene === 5 && (
          <div className="text-center space-y-8 relative z-20">
            <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold bg-gradient-party bg-clip-text text-transparent">
              <TypingText
        ...
        {currentScene === 6 && (
          <div className="text-center space-y-8 max-w-2xl mx-auto">
            ...
            <h3 className="text-4xl font-bold bg-gradient-party bg-clip-text text-transparent">
            ...
            <Button
              ...
              size="lg"
              className="bg-gradient-party text-primary-foreground hover:shadow-glow text-xl px-8 py-4"
            >
              Voir les souhaits 💌
            </Button>
          </div>
        ...
        {currentScene === 7 && (
          <div className="text-center space-y-8 max-w-4xl">
            <div className="animate-text-reveal">
              <h2 className="text-5xl font-bold bg-gradient-party bg-clip-text text-transparent mb-4">
              ...
              <Card className="p-8 bg-card shadow-card animate-card-slide-in max-w-lg mx-auto">
                <div className="space-y-4">
                  <div className="flex items-center justify-center space-x-2">
                    <div className="w-12 h-12 bg-gradient-party rounded-full flex items-center justify-center text-primary-foreground font-bold text-lg">
          ...
          <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 flex space-x-4 z-30">
            {currentScene === 4 && (
              <Button
                ...
                className="bg-gradient-party text-primary-foreground hover:shadow-glow"
              >
                Continuer
              </Button>
            )}
